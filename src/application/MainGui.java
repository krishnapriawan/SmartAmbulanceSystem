...
public class MainGui extends Application {	
	...
	public void start(Stage primaryStage) {
		try {
			...
			SASStart tasStart = new SASStart();
			...
			controller.setSasStart(tasStart);
			controller.setCompositeService(tasStart.getPatientService());
			controller.setProbe(tasStart.getPatientMonitor());
			...
			primaryStage.setTitle("Smart Ambulance System");
			primaryStage.show();
